...
void *connection_handler(void *socket_desc)
{
	...
	{
		//Send the stastus back to client
     ...
     switch (c)
       ...
       case 6:
        ...
        case 7:
            ...
            if (mode == 0)
            {
                if ((digitalRead(RF1) == OFF) && (digitalRead(RF2) == OFF) && (digitalRead(RF3) == OFF) && (digitalRead(RF3) == OFF))
                {
                    return 0;
                } 
            ...
            if (mode == 1)
            {
                ...
                else if ((digitalRead(RF2) == ON) && (digitalRead(RF1) == OFF))
                {
                    return 5;
                }
